...
### 5. 聊天室
* **傳送訊息** 
簡述：這是一個「抽象」的使用案例，代表了所有傳送訊息的行為。它本身不直接被執行，而是由它的子案例「傳送文字」和「傳送圖片」來具體實現。
...
* **查看聊天記錄**
  ...
  二、系統向「聊天伺服器」請求該聊天室的所有歷史訊息。

  三、對於訊息中的圖片連結，系統再向「檔案伺服器」請求對應的圖片。

  四、系統將所有文字和圖片按時間順序呈現在畫面上。
...
* **建立聊天室**
  ...
  三、系統檢查買家與賣家之間是否已存在聊天室。

  四、如果不存在，系統會請求「聊天伺服器」建立一個新的聊天室，並將買賣雙方加入。

  五、系統自動跳轉至這個新的、空白的聊天室畫面。
