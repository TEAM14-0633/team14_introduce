...
* **OCR快速刊登**
  ...
  一、賣家在畫面選擇「OCR快速刊登」功能。
  
  二、系統啟動相機掃描功能。
  
  三、賣家將鏡頭對準書籍的 ISBN 條碼。
  
  四、系統成功辨識條碼後，自動向後端的 OCR服務 或書籍資料庫查詢。
  
  五、系統查詢成功，自動將書名、作者、出版社等資訊填入刊登資訊欄。
  
  六、賣家檢查資訊無誤，設定售價與書況後，點擊「確認刊登」。
  
  七、系統將此筆書籍資料存入資料庫，刊登完成。
...
* **編輯書籍資訊**
  ...
  一、 賣家進入「管理書籍清單」頁面，找到想修改的書籍。
  
  二、賣家點擊該書籍的「編輯」按鈕。
  
  三、系統顯示已填寫好的書籍資訊表單。
  
  四、賣家在此頁面修改書名、作者等文字敘述，同時也一定會看到並可以修改【設定售價與狀態】的欄位。
...
* **上傳書籍圖片**
  ...
  二、系統顯示目前的圖片列表，並提供「新增圖片」按鈕。
  
  三、賣家點擊新增，從手機選擇要上傳的圖片檔。
  
  四、系統將圖片上傳，並與該書籍資料關聯，存入資料庫或檔案系統。
  
  五、賣家可以設定封面圖片，或刪除不要的圖片。
...
* **刪除書籍**
  ...
  一、賣家在「管理書籍清單」中找到要刪除的書籍。
  
  二、賣家點擊「刪除」。
  
  三、系統跳出確認視窗：「確定要刪除這筆上架書籍嗎？此操作無法復原。」
